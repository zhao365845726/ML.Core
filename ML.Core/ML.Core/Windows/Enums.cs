...
namespace ML.Core.Windows
{
    ...
    #region CHANGEFILTERSTRUCTExtStatus
    public enum ChangeFilterStructExtStatus
    {
        /// <summary>
        /// 请参阅备注部分。适用于MSGFLT_ALLOW和MSGFLT_DISALLOW
        /// </summary>
        MSGFLTINFO_NONE = 0,
        /// <summary>
        /// 允许消息的范围高于窗口。适用于MSGFLT_DISALLOW
        /// </summary>
        MSGFLTINFO_ALLOWED_HIGHER = 3,
        /// <summary>
        /// 该消息已被该窗口的消息过滤器所允许，因此该功能成功了，但未更改该窗口的消息过滤器。适用于MSGFLT_ALLOW
        /// </summary>
        MSGFLTINFO_ALREADYALLOWED_FORWND = 1,
        /// <summary>
        /// 该消息已被该窗口的消息过滤器阻止，因此该功能成功了，但未更改该窗口的消息过滤器。适用于MSGFLT_DISALLOW
        /// </summary>
